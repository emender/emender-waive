...
(deftest test-get-exception-message-1
    "Check the function emender-waive.utils/get-exception-message."
    (testing "the function emender-waive.utils/get-exception-message."
        (try
...
(deftest test-third-1
    "Check the function emender-waive.utils/third."
    (testing "the function emender-waive.utils/third."
        (are [x y] (= x y)
            3 (third [1 2 3])
            3 (third [1 2 3 4 5])
            3 (third '(1 2 3))
...
(deftest test-fourth-1
    "Check the function emender-waive/fourth."
    (testing "the function emender-waive/fourth."
        (are [x y] (= x y)
            4 (fourth [1 2 3 4 5])
            4 (fourth '(1 2 3 4))
            4 (fourth '(1 2 3 4 5)))))
...
(deftest test-substring-1
    "Check the function emender-waive.utils/substring."
    (testing "the function emender-waive.utils/substring."
        (are [x y] (= x y)
...
(deftest test-contains-1
    "Check the function emender-waive.utils/contains."
    (testing "the function emender-waive.utils/contains."
        (are [x y] (= x y)
...
(deftest test-starts-with-1
    "Check the function emender-waive.utils/starts-with."
    (testing "the function emender-waive.utils/starts-with."
        (are [x y] (= x y)
...
(deftest test-ends-with-1 "Check the function emender-waive.utils/ends-with."
    (testing "the function emender-waive.utils/ends-with."
        (are [x y] (= x y)
...
(deftest test-ends-with-2
    "Check the function emender-waive.utils/ends-with."
    (testing "the function emender-waive.utils/ends-with."
        (are [x y] (= x y)
...
(deftest test-replaceAll-1
    "Check the function emender-waive.utils/replaceAll."
    (testing "the function emender-waive.utils/replaceAll."
        (are [x y] (= x y)
            ""    (replaceAll "" "" "")
            "b"   (replaceAll "a" "a" "b")
...
(deftest test-parse-boolean
    "Check the behaviour of function emender-waive.utils/parse-boolean."
    (are [x y] (= x y)
...
(deftest test-parse-int-zero
    "Check the behaviour of function emender-waive.utils/parse-int."
    (are [x y] (== x y)
        0 (parse-int "0")
        0 (parse-int "00")
        0 (parse-int "000")
...
(deftest test-parse-float-zero
    "Check the behaviour of function emender-waive.utils/parse-float."
    (are [x y] (== x y)
        0.0 (parse-float "0")
        0.0 (parse-float "00")
        0.0 (parse-float "000")
